...

{
   ...
   const[Mobile,setMobile]=useState ([{"sno": "1","Company":"Samsung","Cost":"10000","Color":"Red","image":"https://jfsexcelr.s3.ap-south-1.amazonaws.com/mobile7.jpeg"},
                ...
                Mobile.map((element,index)=>
                {
                    return(
                        <tr key={index}>
                            ...
                            <td>{element.Cost}</td>
                            <td>{element.Color}</td>
                            <td><img src={element.image} width={100} alt="error"></img></td>                        </tr>
                    )
                })
